...
\item[\textup{(F4)}] \textbf{Open problems.}  A controlled continuum completion of the bosonic spectral action, a derivation of the RG matching from the same action, and a rigorous passage from the discrete graviton observables to 4D PPN/general-relativistic physics remain open.
\end{enumerate}
