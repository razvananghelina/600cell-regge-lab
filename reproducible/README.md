...
| `verify_gravity_600cell_canonical_data_carrier.py` | Target-disclosed exact classification of the 240 modular data directions as vertexwise radial scale plus normal lapse: rational inclusion/exhaustion, alternate-graph and wrong-carrier attacks | potentially minutes |
