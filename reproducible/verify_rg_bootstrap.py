...
# Is (5,25) still the minimum at 2-loop?
best_2l = min(test_points, key=lambda p: cost_2loop(*p))
print(f"\n  2-loop minimum among tested: ({best_2l[0]}, {best_2l[1]})")

# Full 2-loop scan of a few key a1 values
print(f"\n  Full 2-loop scan for a1=4,5,6:")
for a1_val in [4, 5, 6]:
    best_n_2l = None
    best_c_2l = 1e10
    for n_val in range(15, 35):
        ...
        if c < best_c_2l:
            best_c_2l = c
            best_n_2l = n_val
    print(f"    a1={a1_val}: best n={best_n_2l}, cost={best_c_2l:.4e}")
