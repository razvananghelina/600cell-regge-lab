...
#   A = 2*pi           DERIVED as Hopf holonomy; STRUCTURAL in this equation
#   B = 4*a1*phi^4     DERIVED spectral number; STRUCTURAL as 1/alpha_0
#   C_const = 1        NORMALIZATION
...
print()
print("  Coefficients evaluated from a1 = %d (statuses shown below):" % a1)
...
# This test verifies their numerical/algebraic values, not the physical
# identification of the complete equation.

print("TEST 5: Coefficient values and statuses")
print("-" * 72)
print("  Coefficient  | Value              | Origin")
print("  -------------|--------------------|-----------------------------------------")
print("  Quadratic    | 2*pi = %-12.9f | DERIVED holonomy; STRUCTURAL matching" % A_coeff)
print("  Linear       | 4*a1*phi^4 = %-6.9f | DERIVED spectral value; STRUCTURAL coupling" % B_coeff)
...
# Row 5: Coefficients
print("  %-4s | %-35s | %-10s | %-8s | %s" % (
    "5", "Coefficient identities checked", "2pi,4a1p4,1",
...
print()
print("  Note: Solving the stated quadratic is verified numerically. Its physical")
print("  interpretation is STRUCTURAL: the U(1) field normalization and the")
print("  matching of the derived spectral/holonomy numbers remain extra input.")
print("=" * 72)
