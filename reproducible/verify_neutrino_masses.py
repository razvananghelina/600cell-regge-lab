...
What this script does:
  ...
  3. Computes the blind neutrino package m_3, r, m_2, m_1, sum(m_i), m_beta,
     m_bb, and the normal ordering from framework inputs only.
  4. Compares that package with current data (blind comparison).
  5. Cross-checks the PMNS sector, which is derived independently in the A5
     mixing script.
  6. Separates an external-input pattern estimate for M_R that uses the PDG
     top mass and is NOT part of the blind neutrino package.
...
Classification:
  ...
  - M_R = m_t(PDG)*phi^9/2: EXTERNAL-INPUT PATTERN (not blind)
...
# ============================================================================
# SECTION 2: SEESAW EXPONENT n = 35 (DERIVED)
# ============================================================================
...
# ============================================================================
# SECTION 3: BLIND NEUTRINO PACKAGE (DERIVED + PATTERN)
# ============================================================================

print_section("SECTION 3: BLIND NEUTRINO PACKAGE")
...
print("  Status within blind package:")
print("    DERIVED: m_3, r, m_2, sum(m_i), m_beta, m_bb")
...
print_section("SECTION 4: BLIND COMPARISON WITH CURRENT DATA")
...
# ============================================================================
# SECTION 5: PMNS ANGLES (INDEPENDENT DERIVED CROSS-CHECK)
# ============================================================================

print_section("SECTION 5: PMNS ANGLES (INDEPENDENT A5 CROSS-CHECK)")
...
# ============================================================================
# SECTION 6: EXTERNAL-INPUT PATTERN CROSS-CHECK FOR M_R
# ============================================================================

print_section("SECTION 6: EXTERNAL-INPUT PATTERN CROSS-CHECK FOR M_R")
...
print("  (uses PDG top mass; this is NOT part of the blind neutrino package)")
...
print("  Category: EXTERNAL-INPUT PATTERN (depends on PDG top mass)")
...
print()
print("  BLIND PACKAGE (framework inputs only):")
print("    m_1 = 0 meV         (PATTERN)")
print("    m_2 = %.4f meV     (DERIVED)" % (m2 * 1000))
print("    m_3 = %.4f meV    (DERIVED)" % (m3 * 1000))
print("    Sum = %.2f meV     (DERIVED, within all bounds)" % (sum_m_pred * 1000))
print("    Ordering: Normal    (m_1 < m_2 << m_3)")
print("    m_beta = %.4f meV  (DERIVED)" % (m_beta * 1000))
print("    m_bb = %.4f meV    (DERIVED)" % (abs(m_bb) * 1000))
print()
print("  EXTERNAL-INPUT CROSS-CHECK:")
print("    M_R = %.2f TeV     (uses PDG top mass; not blind)" % (M_R / 1e12))
print()
...
if N_FAIL == 0:
    ...
    print("    BLIND DERIVED:    Laplacian ratios, n=35, m_3, r=alpha*phi^3,")
    print("                      m_2, sum(m_i), m_beta, m_bb, normal ordering")
    print("    INDEP. DERIVED:   PMNS angles (A5 cross-check)")
    print("    PATTERN:          m_1 = 0 (rank-2 mass matrix)")
    print("    EXTERNAL-INPUT:   M_R from PDG top mass")
    print()
