#!/usr/bin/env python3
"""Blind shifted action-relative shape-stiffness census on the dust 600-cell.

Prior-art commit: 33da8dd.
Persistence protocol commit: 62810b4.
...
CENTERED_JSON = HERE / "gravity_600cell_dust_shifted_centered.json"
CENTERED_NPZ = HERE / "gravity_600cell_dust_shifted_centered.npz"
SHAPE_JSON = HERE / "gravity_600cell_dust_shifted_conformal_shape.json"
SHAPE_SOURCE = HERE / "verify_gravity_600cell_dust_shifted_conformal_shape.py"
...
OUTPUT = HERE / "gravity_600cell_dust_shifted_shape_stiffness.json"

PRIOR_ART_COMMIT = "33da8dd"
PROTOCOL_COMMIT = "62810b4"
EXPECTED_HASHES = {
    "centered_json": "265bd863de2365f19f7679373155fdaa23fb0bb3e75c221cfd9d9ec5b6ac2a47",
    "centered_npz": "c000f4fcae67e6c0648046878c2bd1ffd0616c38510ccf788c67cf99832397b8",
    "shape_json": "acf9029114fee28800ad4cf6bff131fe59c5a8a22f7c8f7fa334b5a454842ec2",
    "shape_source": "95b5c282c18cbdcf1fb9c87e5c8e62605062063f8c553f8b6f81f90c178c2303",
...
print("=" * 78)
print("600-CELL SHIFTED ACTION-RELATIVE SHAPE STIFFNESS CENSUS")
print("=" * 78)
...
provenance_ok = bool(
    ...
    and centered["outcome"] == "SHIFTED_CENTERED_CERTIFIED"
    ...
    and shape_source_result["passed"] == shape_source_result["tests"] == 11
...
if not controls_ok:
    outcome = "SHIFTED_SHAPE_STIFFNESS_CONTROL_FAILED"
elif carrier_open or kinetic_counts["KINETIC_OPEN"] > 0:
    outcome = "SHIFTED_SHAPE_STIFFNESS_CARRIER_OPEN"
elif any_complex or any_action_mismatch:
    outcome = "SHIFTED_SHAPE_STIFFNESS_COMPLEX_OR_ACTION_MISMATCH"
elif any_schedule_dependent:
    outcome = "SHIFTED_SHAPE_STIFFNESS_SCHEDULE_DEPENDENT"
elif any_negative:
    outcome = "SHIFTED_SHAPE_STIFFNESS_NEGATIVE_MODES_RESOLVED"
elif any_open:
    outcome = "SHIFTED_SHAPE_STIFFNESS_SIGN_OPEN"
elif any_zero:
    outcome = "SHIFTED_SHAPE_STIFFNESS_NONNEGATIVE_WITH_ZERO_MODES"
else:
    outcome = "SHIFTED_SHAPE_STIFFNESS_POSITIVE_CENSUS"

outcome_complete = outcome in {
    "SHIFTED_SHAPE_STIFFNESS_CONTROL_FAILED",
    "SHIFTED_SHAPE_STIFFNESS_CARRIER_OPEN",
    "SHIFTED_SHAPE_STIFFNESS_COMPLEX_OR_ACTION_MISMATCH",
    "SHIFTED_SHAPE_STIFFNESS_SCHEDULE_DEPENDENT",
    "SHIFTED_SHAPE_STIFFNESS_NEGATIVE_MODES_RESOLVED",
    "SHIFTED_SHAPE_STIFFNESS_SIGN_OPEN",
    "SHIFTED_SHAPE_STIFFNESS_NONNEGATIVE_WITH_ZERO_MODES",
    "SHIFTED_SHAPE_STIFFNESS_POSITIVE_CENSUS",
}
