#!/usr/bin/env python3
"""Blind centered census for the shifted Regge Jacobi stencil.

Prior-art commit: 920ce5d.
Preregistered protocol commit: a320fe4.
...
SOURCE_JSON = HERE / "gravity_600cell_dust_shifted_jacobi.json"
SOURCE_NPZ = HERE / "gravity_600cell_dust_shifted_jacobi.npz"
SOURCE_VERIFIER = HERE / "verify_gravity_600cell_dust_shifted_jacobi.py"
OUTPUT = HERE / "gravity_600cell_dust_shifted_centered.json"
NUMERIC_OUTPUT = HERE / "gravity_600cell_dust_shifted_centered.npz"

PRIOR_ART_COMMIT = "920ce5d"
PROTOCOL_COMMIT = "a320fe4"
EXPECTED_HASHES = {
    "json": "63b37b6000146d5d53dbbc01da5c9aba9a5e3373b8bc3830a404ef0f681ecf31",
    "npz": "d2f507c4a2fa11c5d7a808849c199a986278516f422cf43654f6de153ab170d0",
    "verifier": "fc070de1a5f89524f119fd09ae25611559cb0bb64defbd34486b7980f058470d",
}
VARIANTS = (
    "operational_primary",
    "operational_shadow",
...
provenance_ok = bool(
    ...
    and source_json["outcome"] == "SHIFTED_JACOBI_CERTIFIED"
    and source_json["passed"] == source_json["tests"] == 8
...
print("=" * 78)
print("BLIND SHIFTED CENTERED MASS--DRIFT--STIFFNESS CENSUS")
print("=" * 78)
...
if not controls_ok:
    outcome = "SHIFTED_CENTERED_CONTROL_FAILED"
elif not all_mass_regular:
    outcome = "SHIFTED_CENTERED_MASS_SINGULAR"
elif not all_centered_identities:
    outcome = "SHIFTED_CENTERED_IDENTITY_FAILED"
elif resolved_dependent:
    outcome = "SHIFTED_CENTERED_SCHEDULE_DEPENDENT"
elif primary_open:
    outcome = "SHIFTED_CENTERED_SCHEDULE_OPEN"
else:
    outcome = "SHIFTED_CENTERED_CERTIFIED"

allowed = {
    "SHIFTED_CENTERED_CONTROL_FAILED",
    "SHIFTED_CENTERED_MASS_SINGULAR",
    "SHIFTED_CENTERED_IDENTITY_FAILED",
    "SHIFTED_CENTERED_SCHEDULE_DEPENDENT",
    "SHIFTED_CENTERED_SCHEDULE_OPEN",
