#!/usr/bin/env python3
"""Shifted dynamic closure of the canonical conformal/shape supermetric split.
...
OUTPUT = HERE / "gravity_600cell_dust_shifted_conformal_shape.json"
...
print("=" * 78)
print("600-CELL SHIFTED CONFORMAL / SHAPE DYNAMIC CLOSURE GATE")
print("=" * 78)
...
if not controls_ok:
    outcome = "SHIFTED_CONFORMAL_SHAPE_CONTROL_FAILED"
elif carrier_open:
    outcome = "SHIFTED_CONFORMAL_SHAPE_CARRIER_OPEN"
elif any_nonzero:
    outcome = "SHIFTED_CONFORMAL_SHAPE_MIXING_REFUTED"
elif any_open or not all_zero:
    outcome = "SHIFTED_CONFORMAL_SHAPE_DYNAMICS_OPEN"
else:
    outcome = "SHIFTED_CONFORMAL_SHAPE_DYNAMICS_DECOUPLED"
