...
global homogeneous shape-selection result.  It still does not compare the
interior of the smooth--Regge family.  The two endpoints can now be compared
...
prefers the round endpoint, but this is not yet a complete metric action.
