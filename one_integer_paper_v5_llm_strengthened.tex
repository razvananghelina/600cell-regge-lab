...
\item \textbf{Gravity.} The finite Hodge decomposition, the exact discrete scalar-response identity $\gamma_{\mathrm{disc}}=1$, the coexact/scalar multiplicity ratio, and the positive-definite edge-weight Hessian are derived algebraic facts.  None yet supplies a spin-2 field dictionary, diffeomorphism quotient, Lorentzian propagator, universal stress-tensor coupling, or 4D continuum limit.  Emergent gravity, PPN, and nonlinear GR therefore remain open rather than derived.
